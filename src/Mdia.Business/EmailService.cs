...
{
    public class EmailService : INotificationProvider<Email, bool>
    {
        private readonly string _smtpServer;
        private readonly string _adminEmail;

        public EmailService(string smtpServer, string adminEmail)
        {
        ...
        public bool Send(Email mail)
        {
            try
            {
                ...
                smtp.PickupDirectoryLocation = @"C:\Users\Dan\Documents\Visual Studio 2015\Projects\Mdia\Mdia.WebAPI\Content\mail";
